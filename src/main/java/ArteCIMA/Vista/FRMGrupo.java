...
import ArteCIMA.Controlador.ControladorGrupo;
...
public class FRMGrupo extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FRMGrupo.class.getName());
    private final ControladorGrupo controlador = new ControladorGrupo();
    ...
    private void cargarTabla() {
        List<Grupo> lista = controlador.listar();
        DefaultTableModel model = (DefaultTableModel) tblGrupos.getModel();
        model.setRowCount(0);
        for (Grupo g : lista) {
            model.addRow(new Object[]{
                g.getIdGrupo(), g.getNombre(), g.getHorario(),
                g.getNumMaxEstudiantes(), g.getIdTaller()
            });
        }
    }
    ...
    private void cargarDatosFilaSeleccionada() {
        ...
        txtHorario.setText(valor(model, fila, 2));
        txtNumMax.setText(valor(model, fila, 3));
        txtIdTaller.setText(valor(model, fila, 4));
    }
    ...
    private Grupo obtenerDesdeCampos(Integer id) {
        Grupo g = new Grupo();
        if (id != null) g.setIdGrupo(id);
        g.setNombre(txtNombre.getText().trim());
        g.setHorario(txtHorario.getText().trim());
        g.setNumMaxEstudiantes(txtNumMax.getText().trim().isEmpty() ? null : Integer.parseInt(txtNumMax.getText().trim()));
        g.setIdTaller(txtIdTaller.getText().trim().isEmpty() ? null : Integer.parseInt(txtIdTaller.getText().trim()));
        return g;
    }

    private boolean validarCampos() {
        if (txtNombre.getText().trim().isEmpty()) {
            MensajesUI.advertencia(this, "El nombre del grupo es obligatorio.");
            return false;
        }
        try {
            if (!txtNumMax.getText().trim().isEmpty()) Integer.parseInt(txtNumMax.getText().trim());
            if (!txtIdTaller.getText().trim().isEmpty()) Integer.parseInt(txtIdTaller.getText().trim());
        } catch (NumberFormatException e) {
            MensajesUI.advertencia(this, "Los campos numéricos deben ser enteros válidos.");
            return false;
        }
        return true;
    }
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            try {
                if (Integer.parseInt(model.getValueAt(i, 0).toString()) == id) {
                    tblGrupos.setRowSelectionInterval(i, i);
                    tblGrupos.scrollRectToVisible(tblGrupos.getCellRect(i, 0, true));
                    break;
                }
    ...
    private void initComponents() {
        ...
        txtHorario.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        jLabel5.setText("Máx. estudiantes:");

        txtNumMax.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N

        jLabel6.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        jLabel6.setText("ID taller:");

        txtIdTaller.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        ...
        tblGrupos.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        tblGrupos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_grupo", "Nombre", "Horario", "Max_estudiantes", "ID_taller"
            }
        ) {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtNumMax, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel6)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtIdTaller, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        ...
        try {
            Grupo g = obtenerDesdeCampos(null);
            if (controlador.controlarAccion(evt, g)) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            Grupo g = obtenerDesdeCampos(Integer.parseInt(tblGrupos.getValueAt(fila, 0).toString()));
            if (controlador.controlarAccion(evt, g)) {
                MensajesUI.exito(this, controlador.getUltimoMensaje());
                cargarTabla(); limpiarCampos();
            } else MensajesUI.exito(this, controlador.getUltimoMensaje());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        Grupo g = new Grupo();
        g.setIdGrupo(Integer.parseInt(tblGrupos.getValueAt(fila, 0).toString()));
        if (controlador.controlarAccion(evt, g)) {
            MensajesUI.exito(this, controlador.getUltimoMensaje());
            cargarTabla(); limpiarCampos();
        } else MensajesUI.exito(this, controlador.getUltimoMensaje());
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        limpiarCampos();
        if (g == null) { MensajesUI.sinResultadosBusqueda(this); return; }
        txtNombre.setText(g.getNombre() == null ? "" : g.getNombre());
        txtHorario.setText(g.getHorario() == null ? "" : g.getHorario());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FRMGrupo().setVisible(true));
    }
