...
import ArteCIMA.Controlador.ControladorAcudiente;
...
public class FRMAcudiente extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FRMAcudiente.class.getName());
    private final ControladorAcudiente controlador = new ControladorAcudiente();
    ...
    private void cargarTabla() {
        List<Acudiente> lista = controlador.listar();
        DefaultTableModel model = (DefaultTableModel) tblAcudientes.getModel();
        model.setRowCount(0);
        for (Acudiente a : lista) {
            model.addRow(new Object[]{
                a.getIdAcudiente(), a.getTipoDocumento(), a.getNumDocumento(),
                a.getNombreCompleto(), a.getParentesco(), a.getTelefono(), a.getCorreo()
            });
        }
    }

    private void cargarDatosFilaSeleccionada() {
        int fila = tblAcudientes.getSelectedRow();
        if (fila == -1) return;
        DefaultTableModel model = (DefaultTableModel) tblAcudientes.getModel();
        comboTipoDoc.setSelectedItem(model.getValueAt(fila, 1) == null ? "Selecciona" : model.getValueAt(fila, 1).toString());
        txtNumDocumento.setText(valor(model, fila, 2));
        txtNombreCompleto.setText(valor(model, fila, 3));
        txtParentesco.setText(valor(model, fila, 4));
        txtTelefono.setText(valor(model, fila, 5));
        txtCorreo.setText(valor(model, fila, 6));
    }
    ...
    private Acudiente obtenerDesdeCampos(Integer id) {
        Acudiente a = new Acudiente();
        if (id != null) a.setIdAcudiente(id);
        String tipoDoc = comboTipoDoc.getSelectedItem().toString();
        a.setTipoDocumento("Selecciona".equals(tipoDoc) ? null : tipoDoc);
        a.setNumDocumento(txtNumDocumento.getText().trim());
        a.setNombreCompleto(txtNombreCompleto.getText().trim());
        a.setParentesco(txtParentesco.getText().trim());
    ...
    private boolean validarCampos() {
        if (txtNombreCompleto.getText().trim().isEmpty()) {
            MensajesUI.advertencia(this, "El nombre completo es obligatorio.");
            return false;
        }
        return true;
    }
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            try {
                if (Integer.parseInt(model.getValueAt(i, 0).toString()) == id) {
                    tblAcudientes.setRowSelectionInterval(i, i);
                    tblAcudientes.scrollRectToVisible(tblAcudientes.getCellRect(i, 0, true));
                    break;
                }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("GESTIÓN DE ACUDIENTES");
        ...
        jLabel4.setText("Núm. documento:");

        txtNumDocumento.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        jLabel5.setText("Nombre completo:");

        txtNombreCompleto.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N

        jLabel6.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        jLabel6.setText("Parentesco:");

        txtParentesco.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        ...
        tblAcudientes.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        tblAcudientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_acudiente", "Tipo_doc", "Num_doc", "Nombre", "Parentesco", "Teléfono", "Correo"
            }
        ) {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(comboTipoDoc, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtNumDocumento, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtParentesco, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        ...
        Acudiente a = obtenerDesdeCampos(null);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        Acudiente a = obtenerDesdeCampos(Integer.parseInt(tblAcudientes.getValueAt(fila, 0).toString()));
        if (controlador.controlarAccion(evt, a)) {
            MensajesUI.exito(this, controlador.getUltimoMensaje());
            cargarTabla(); limpiarCampos();
        } else MensajesUI.exito(this, controlador.getUltimoMensaje());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        Acudiente a = new Acudiente();
        a.setIdAcudiente(Integer.parseInt(tblAcudientes.getValueAt(fila, 0).toString()));
        if (controlador.controlarAccion(evt, a)) {
            MensajesUI.exito(this, controlador.getUltimoMensaje());
            cargarTabla(); limpiarCampos();
        } else MensajesUI.exito(this, controlador.getUltimoMensaje());
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        comboTipoDoc.setSelectedItem(a.getTipoDocumento() == null ? "Selecciona" : a.getTipoDocumento());
        txtNumDocumento.setText(a.getNumDocumento() == null ? "" : a.getNumDocumento());
        txtNombreCompleto.setText(a.getNombreCompleto() == null ? "" : a.getNombreCompleto());
        txtParentesco.setText(a.getParentesco() == null ? "" : a.getParentesco());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FRMAcudiente().setVisible(true));
    }
